...
function taskCountdownLabel(task) { const seconds = taskRemaining(task); return seconds ? `بعد ${formatDuration(seconds)}` : 'جارٍ التنفيذ الآن'; }
