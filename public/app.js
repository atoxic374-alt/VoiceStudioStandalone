...
function renderProfiles(clients = []) {
  ...
  // Keep the dashboard readable on phones while still showing more accounts
  // per page than the old five-account limit.
  const pageSize = 10;
